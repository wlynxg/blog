...
![](../assets/2025-05-31-21-33-43-image.png)
...
![](../assets/2025-05-31-21-51-52-image.png)
...
![](../assets/b4da23af3ae26629c8e8b1c6752934f318e6becb.png)
...
1. 利用发起函数调用的 goroutine addr 作为 key 值，在缓存中查询`traceparent id`。如果查询不到再使用 父goroutine addr、祖父 goroutine addr 进行查询。若有则直接返回；

2. 以上都没有则生成一个新的`traceparent id`并返回。
...
![](../assets/043e66218cf4225d787d981989342d539c022738.png)
